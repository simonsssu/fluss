...
public class FlussCliMain extends BaseCmd<Integer> {
                    ...
                    .forEach(
                            clazz -> {
                                try {
                                    ...
                                    System.err.printf(
                                            "Failed to load command :%s", clazz.getSimpleName());
                                }
                            });

            if (SUB_COMMANDS.isEmpty()) {
                System.err.println("No subcommands detected in classpath");
            }
        } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err.printf("Critical execution failure: %s", ex.getMessage());
